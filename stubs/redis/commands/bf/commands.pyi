...
from redis.exceptions import ModuleError as ModuleError
from redis.utils import HIREDIS_AVAILABLE as HIREDIS_AVAILABLE, deprecated_function as deprecated_function
...
class BFCommands:
    ...
    def insert(self, key, items, capacity: Incomplete | None = ..., error: Incomplete | None = ..., noCreate: Incomplete | None = ..., expansion: Incomplete | None = ..., noScale: Incomplete | None = ...): ...
...
class CFCommands:
    def create(self, key, capacity, expansion: Incomplete | None = ..., bucket_size: Incomplete | None = ..., max_iterations: Incomplete | None = ...): ...
    reserve = create
    def add(self, key, item): ...
...
class TDigestCommands:
    ...
    def merge(self, destination_key, num_keys, *keys, compression: Incomplete | None = ..., override: bool = ...): ...
    def min(self, key): ...
    def max(self, key): ...
