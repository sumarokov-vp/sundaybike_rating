...
class HandlerBackend:
    handlers: Incomplete
    def __init__(self, handlers: Incomplete | None = ...) -> None: ...
...
class FileHandlerBackend(HandlerBackend):
    ...
    delay: Incomplete
    timer: Incomplete
    def __init__(self, handlers: Incomplete | None = ..., filename: str = ..., delay: int = ...) -> None: ...
    def register_handler(self, handler_group_id, handler) -> None: ...
    def clear_handlers(self, handler_group_id) -> None: ...
    def get_handlers(self, handler_group_id): ...
    def start_save_timer(self) -> None: ...
    def save_handlers(self) -> None: ...
    def load_handlers(self, filename: Incomplete | None = ..., del_file_after_loading: bool = ...) -> None: ...
    @staticmethod
    def dump_handlers(handlers, filename, file_mode: str = ...) -> None: ...
    @staticmethod
    def return_load_handlers(filename, del_file_after_loading: bool = ...): ...

class RedisHandlerBackend(HandlerBackend):
    prefix: Incomplete
    redis: Incomplete
    def __init__(self, handlers: Incomplete | None = ..., host: str = ..., port: int = ..., db: int = ..., prefix: str = ..., password: Incomplete | None = ...) -> None: ...
    def register_handler(self, handler_group_id, handler) -> None: ...
    def clear_handlers(self, handler_group_id) -> None: ...
    def get_handlers(self, handler_group_id): ...
